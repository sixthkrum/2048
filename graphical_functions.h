...
mvprintw(i0 * 3 + 1 , i1 * 7 + 1 , "%d" , numarr[i0][i1]);//3 is for the seperation b/w the box tops and 7 for the box width seperation box width itself is 6 (inside width) and the distance between two shown numbers is always 7
